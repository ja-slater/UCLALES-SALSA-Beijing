...
100 CONTINUE
 ...
 SUBROUTINE init_gas_tracers
    ...
    DO j = 1, nyp
       DO i = 1, nxp
          DO k = 1, nzp
             a_gaerop(k,i,j,1) = 5.E14/dn0(k) !SO4 !Changed from 5.E14 to 3.E15 by JS
             a_gaerop(k,i,j,2) = 0./dn0(k)    !NO3 !Changed from 0 to 5.E14
             a_gaerop(k,i,j,3) = 0./dn0(k)    !NH4 Changed from 0 to 1.E16
             a_gaerop(k,i,j,4) = 5.E14/dn0(k) !OCNV !Changed from 5.E14 to 5.E16
             a_gaerop(k,i,j,5) = 1.E14/dn0(k) !OCSV !Changed from 1.E14 to 1.E15 JS 16/11/18
          END DO
       END DO
    END DO
